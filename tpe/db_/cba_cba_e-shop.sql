...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-10-2023 a las 17:08:03
...
(10, 'Veraniega', 12, 1200),
(15, 'Bosque Sherwood', 12, 450);
...
(1, 'admin', '$2y$10$x1Ycx6YYxpd4LYbwQMq1ouUVxlnPGLZwdSe9h3vuFsMLO2BJn.2VG'),
...
--
ALTER TABLE `campeones`
  MODIFY `Champion_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `skins`
--
ALTER TABLE `skins`
  MODIFY `Skin_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `transacciones`
--
ALTER TABLE `transacciones`
  MODIFY `Transaction_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `transacciones`
  ADD CONSTRAINT `transacciones_ibfk_1` FOREIGN KEY (`Champion_id`) REFERENCES `campeones` (`Champion_id`),
  ADD CONSTRAINT `transacciones_ibfk_2` FOREIGN KEY (`Skin_id`) REFERENCES `skins` (`Skin_id`),
