...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2023 a las 05:06:46
...
--
ALTER TABLE `skins`
  MODIFY `Skin_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `transacciones`
--
ALTER TABLE `transacciones`
  MODIFY `Transaction_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
